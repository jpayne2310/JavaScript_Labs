   ...
   function showState (what)
	...
	function addActor ()
	{
		...
		$("#actorsTable").append("<tr><td><a href='' class='update'>" + newActor.fName +
						  " " + newActor.lName ); /*+ " " + newActor.DOB + " " + newActor.gender +
						  " " + newActor.action + " " + newActor.comedy + " " + newActor.drama +
						  " " + newActor.scienceFiction + "</a></td></tr>");*/
    ...
    //make sure that at least on checkbox has been checked
